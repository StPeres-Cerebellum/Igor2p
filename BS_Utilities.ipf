...
function BetterCutNMRasters(newname)
	string newname
	
	string rasterXName= waveList("SP_RX_*","","")
	wave rasterx = $rasterXName
	string rasterYName= waveList("SP_RY_*","","")
	wave rastery = $rasteryName
